...
public class J7zip {
	static void PrintHelp() {
		System.out
				.println("\nUsage:  JZip <l|t|x> <archive_name> <output_directory> [<file_names>...]\n"
						+ "  l : Lists files\n"
						+ "  t : Tests archive.7z\n"
						+ "  x : eXtracts files\n");
	}
	...
	static void testOrExtract(IInArchive archive, Vector<String> listOfNames,
			int mode, String outputDirPath) throws Exception {
		testOrExtract(archive, listOfNames, mode, new File(outputDirPath));
	}

	static void testOrExtract(IInArchive archive, Vector<String> listOfNames,
			int mode, File outputDir) throws Exception {
	...
	public static void extract(String file, String output) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		case MODE_TESTING:
			testOrExtract(archive, listOfNames,
					IInArchive.NExtract_NAskMode_kTest, outputDirPath);
			break;
		case MODE_EXTRACT:
			testOrExtract(archive, listOfNames,
					IInArchive.NExtract_NAskMode_kExtract, outputDirPath);
			break;
		}
