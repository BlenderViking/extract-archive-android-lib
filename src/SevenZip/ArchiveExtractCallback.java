...
// ICryptoGetTextPassword,
{
	...
	public ArchiveExtractCallback(String _outputDirPath) throws IOException {
		setOutputDirPath(_outputDirPath);
		PasswordIsDefined = false;
	}

	public ArchiveExtractCallback(File _outputDir) throws IOException {
		setOutputDir(_outputDir);
		PasswordIsDefined = false;
	}

	public void setOutputDirPath(String _outputDirPath) throws IOException {
		setOutputDir(new File(_outputDirPath));
	}

	public void setOutputDir(File _outputDir) throws IOException {
		...
		outputDirPath = _outputDir.getAbsolutePath();
	}
	...
	public int GetStream(int index, java.io.OutputStream[] outStream,
		...
		File file = new File(outputDirPath + File.separator + _filePath);
		...
		case IInArchive.NExtract_NAskMode_kExtract:
			...
			try {
				...
				java.io.RandomAccessFile outStr = new java.io.RandomAccessFile(
						outputDirPath + File.separator + _filePath, "rw");
