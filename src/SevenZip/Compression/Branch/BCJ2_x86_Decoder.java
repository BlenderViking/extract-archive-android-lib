...
public class BCJ2_x86_Decoder implements ICompressCoder2 {
	...
	SevenZip.Compression.RangeCoder.BitDecoder _statusE9Decoder = new SevenZip.Compression.RangeCoder.BitDecoder(
			kNumMoveBits);
	SevenZip.Compression.RangeCoder.BitDecoder _statusJccDecoder = new SevenZip.Compression.RangeCoder.BitDecoder(
			kNumMoveBits);
	...
	int CodeReal(RecordVector<java.io.InputStream> inStreams,
		...
		for (int i = 0; i < 256; i++) {
			_statusE8Decoder[i] = new SevenZip.Compression.RangeCoder.BitDecoder(
					kNumMoveBits);
	...
	@Override
	public int Code(RecordVector<java.io.InputStream> inStreams, // ISequentialInStream
																	// **inStreams,
			Object useless_inSizes, // const UInt64 ** /* inSizes */,
			int numInStreams, RecordVector<java.io.OutputStream> outStreams, // ISequentialOutStream
																				// **outStreams
